...
Test this function by hand in the console to get it working, and when you think it is finished, uncomment the call for the testSum() 
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let b = sumArr[1];
  let c = sumArr[2];
  sum(sumArr[0], sumArr[1])[0];

  let sum1 = sum(a, b)[0];
  let sum2 = sum(sum1, c)[0];

  let str = `${a},${b},${c} was passed in as an array of numbers, and ${sum2} is their sum.`
